...
export default function ConnectSection() {
  return (
    <section id="connect" className="py-16 md:py-24 bg-black text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-400 mt-4">Follow us on social media or reach out directly through our messaging channels.</p>
        </motion.div>
        ...
        >
          {/* WhatsApp */}
          <div className="bg-slate-300 rounded-xl shadow-lg overflow-hidden transition-transform hover:scale-105">
